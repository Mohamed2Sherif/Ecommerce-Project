...
class User(AbstractBaseUser, PermissionsMixin):
    User_ID = models.UUIDField(primary_key=True,default=uuid.uuid4,db_index=True,unique=True,editable=False)
    username = models.CharField(db_index = True,unique=True,max_length=25)
    ...
    #TODO: Create the save method for user model
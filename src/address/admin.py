...
class AddressAdmin(admin.ModelAdmin):
    list_display = ['user', 'address_type', 'effective_date', 'address_line_1', 'city', 'country', 'zip_code']
    ...
    fieldsets = [
        ...
        ('Address Details', {'fields': ['address_type', 'effective_date', 'address_line_1', 'address_line_2', 'city', 'country', 'zip_code']}),
    ]
